...
LDFLAGS = -X my5Gcore/src/$(@F)/version.VERSION=$(VERSION) \
          -X my5Gcore/src/$(@F)/version.BUILD_TIME=$(BUILD_TIME) \
          -X my5Gcore/src/$(@F)/version.COMMIT_HASH=$(COMMIT_HASH) \
          -X my5Gcore/src/$(@F)/version.COMMIT_TIME=$(COMMIT_TIME)
